...
adj2_dw_post = dw_post.RW_MH(
    mcmc_niter, adjusted=True, acceptance_lag=acceptance_lag, C=dw.C2
)
adj3_dw_post = dw_post.RW_MH(
    mcmc_niter, adjusted=True, acceptance_lag=acceptance_lag, C=dw.C3
)
adj4_dw_post = dw_post.RW_MH(
    mcmc_niter, adjusted=True, acceptance_lag=acceptance_lag, C=dw.C4
)
adj5_dw_post = dw_post.RW_MH(
    mcmc_niter, adjusted=True, acceptance_lag=acceptance_lag, C=dw.C5
)
adj52_dw_post = dw_post.RW_MH(
    mcmc_niter, adjusted=True, acceptance_lag=acceptance_lag, C=dw.C5_2
)
adj6_dw_post = dw_post.RW_MH(
    mcmc_niter, adjusted=True, acceptance_lag=acceptance_lag, C=dw.C6
)
...
if False:
    ...
    gauss_post = RW_MH(
        ...
        gauss.res.x,
        gauss,
        compute_hessian(gauss, gauss.res.x, approx_grad=True, inv=True),
        acceptance_lag=100,
    )
