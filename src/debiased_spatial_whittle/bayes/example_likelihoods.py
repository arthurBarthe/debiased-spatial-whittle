...
adj2_dw_post = RW_MH(
    ...
    dw.res.x,
    dw.adj_loglik,
    compute_hessian(dw.adj_loglik, dw.res.x, inv=True, C=dw.C2),
    C=dw.C2,
)
adj3_dw_post = RW_MH(
    mcmc_niter,
    dw.res.x,
    dw.adj_loglik,
    compute_hessian(dw.adj_loglik, dw.res.x, inv=True, C=dw.C3),
    C=dw.C3,
)
adj4_dw_post = RW_MH(
    mcmc_niter,
    dw.res.x,
    dw.adj_loglik,
    compute_hessian(dw.adj_loglik, dw.res.x, inv=True, C=dw.C4),
    C=dw.C4,
)
adj5_dw_post = RW_MH(
    mcmc_niter,
    dw.res.x,
    dw.adj_loglik,
    compute_hessian(dw.adj_loglik, dw.res.x, inv=True, C=dw.C5),
    C=dw.C5,
)
adj52_dw_post = RW_MH(
    mcmc_niter,
    dw.res.x,
    dw.adj_loglik,
    compute_hessian(dw.adj_loglik, dw.res.x, inv=True, C=dw.C5_2),
    C=dw.C5_2,
)
adj6_dw_post = RW_MH(
    mcmc_niter,
    dw.res.x,
    dw.adj_loglik,
    compute_hessian(dw.adj_loglik, dw.res.x, inv=True, C=dw.C6),
    C=dw.C6,
)
