...
plt.rcParams.update({'font.size': 18.0, 'axes.spines.top': False, 'axes.spines.right': False}) 
...
prior = multivariate_normal([12., 1.2], np.array([[0.5, 0.], [0., 0.0625]]))
...
for i_dataset in range(n_datasets):
    ...
    adj2_dw_post  = dw_posterior.RW_MH(n_mcmc, adjusted=True, acceptance_lag=1000, C=dw.C2)
    adj4_dw_post  = dw_posterior.RW_MH(n_mcmc, adjusted=True, acceptance_lag=1000, C=dw.C4)
    adj5_dw_post  = dw_posterior.RW_MH(n_mcmc, adjusted=True, acceptance_lag=1000, C=dw.C5)
